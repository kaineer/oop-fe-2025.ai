...
- Создайте метод объекта, который возвращает функцию, привязанную к контексту этого объекта (функция должна иметь доступ к данным исходного объекта при вызове снаружи)
