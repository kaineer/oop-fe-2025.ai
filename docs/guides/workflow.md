...
Для получения более детальных рекомендаций по созданию эффективных промптов и документов, обратитесь к следующим документам:

- [Лучшие практики формирования промптов](prompt_best_practices.md)
- [Предпочтения автора по разработке](author_preferences.md)
