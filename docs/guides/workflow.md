...
practice_exercises:
  - name: "Название упражнения"
    ...
    # Для практических уроков могут быть дополнительные поля:
...
### Шаг 1: Создание промпта
Для практических уроков промпт включает дополнительные разделы:
...
### Шаг 2: Генерация документов
Для практических уроков создаются специализированные документы:
...
- **Реальное применение**: Выбирать задания, которые решают реальные проблемы и имеют практическое применение.
